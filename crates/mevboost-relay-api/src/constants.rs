...
lazy_static! {
    ...
    pub static ref DEFAULT_RELAYS: HashMap<&'static str, &'static str> = {
        ...
        m.insert("bloxroute", "https://0x8b5d2e73e2a3a55c6c87b8b6eb92e0149a125c852751db1422fa951e42a09b82c142c3ea98d0d9930b056a3bc9896b8f@bloxroute.max-profit.blxrbdn.com");
        m
    };
